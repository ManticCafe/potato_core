...
public class the_last_sword_level7 extends SwordItem {

    private static final int PROJECTILE_DAMAGE = configReader.getl7_projectile_damage();

    public the_last_sword_level7() {
        super(infinite_tier.INFINITE_TIER,80,4.0F,new Item.Properties().durability(-1).rarity(Rarity.EPIC));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            //技能CD
            player.getCooldowns().addCooldown(this, configReader.getl7_cd());
        }
