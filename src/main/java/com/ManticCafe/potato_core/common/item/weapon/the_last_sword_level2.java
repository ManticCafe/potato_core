...
public class the_last_sword_level2 extends SwordItem {
    ...
    private static final int PROJECTILE_DAMAGE = configReader.getl2_projectile_damage();

    public the_last_sword_level2() {
        super(infinite_tier.INFINITE_TIER,24,1,new Item.Properties().durability(-1).rarity(Rarity.EPIC));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            //技能CD
            player.getCooldowns().addCooldown(this, configReader.getl2_cd());
        }
